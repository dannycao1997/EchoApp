...
const pinModalData: Readonly<PinModalData[]> = [
  {
    ...
    description:
      'This will appear at the top of your profile and replace any previously pinned Echo.',
    mainBtnLabel: 'Pin'
  },
  {
...
export function TweetActions({
  ...
  const handleRemove = async (): Promise<void> => {
    ...
    toast.success(
      `${isInAdminControl ? `@${username}'s` : 'Your'} Echo was deleted`
    );
  ...
  const handlePin = async (): Promise<void> => {
    ...
    toast.success(
      `Your echo was ${tweetIsPinned ? 'unpinned' : 'pinned'} to your profile`
    );
    pinCloseModal();
  };
